...
class BiDAF(nn.Module):
    def __init__(self, args, pretrained):
        ...
        self.char_embedding = nn.Embedding(args.char_vocab_size, args.char_dim, padding_idx=1)
    ...
    def forward(self, batch):
        ...
        def char_emb_layer(x):
            ...
            x = self.char_convolution(x).squeeze()
        ...
        # 2. Word Embedding Layer
        c_word = self.word_embedding(batch.c_word[0])
        q_word = self.word_embedding(batch.q_word[0])
